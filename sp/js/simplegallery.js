...
simpleGallery.prototype={
	...
	showslide:function(keyword){
		...
		setting.gallerylayers[setting.fglayer].style.zIndex=9 //foreground layer becomes background
...
simpleGallery.routines={
	...
	addnavpanel:function(setting){
		...
		setting.$navpanel=$('<div class="navpanellayer"></div>')
			...
			.css({position:'absolute', width:'100%', height:setting.panelheight, left:0, top:setting.dimensions[1], font:simpleGallery_navpanel.panel.fontStyle, zIndex:'11'})
	...
	adddescpanel:function(setting){
		...
		setting.$descpanel=$('<div class="gallerydesc"><div class="gallerydescbg"></div><div class="gallerydescfg"><div class="gallerydesctext"></div></div></div>')
			...
			.css({position:'absolute', width:'100%', left:0, top:-1000, zIndex:'11'})
