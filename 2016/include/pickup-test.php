...
<!-- 掲載予定日時に応じてhtml表示例 -->
<?php include_once($_SERVER['DOCUMENT_ROOT'] . '/2016/include/time_pickup.php');
    /* ここに掲載したい div を記載して ''で囲む(コメント記載方法はphpの場合htmlと異なるため注意) */
    $show_str = '
        <div class="column-inner">
        <span class="label-2">映像</span>
        <span>NEW</span>
    ...
    show_div($show_str, $start_date, $end_date);
?>
